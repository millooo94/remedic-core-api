...
{
    public const KEYS = ['medical_areas_index', 'equipe_index', 'checkups_index', 'diagnostics_index', 'aesthetic_medicine_index', 'news_index', 'health_pills_index', 'conventions_network_index'];
    ...
    {
        return match ($key) {
            'medical_areas_index' => ['eyebrow', 'title', 'body'],
            ...
            'news_index' => ['breadcrumb_label', 'eyebrow', 'title', 'subtitle', 'body', 'featured_label', 'featured_cta_label', 'latest_title', 'secondary_eyebrow', 'secondary_cta_label', 'archive_title', 'archive_body', 'search_placeholder', 'all_label'],
            'health_pills_index' => ['breadcrumb_label', 'eyebrow', 'title', 'body', 'featured_eyebrow', 'featured_cta_label', 'latest_title', 'archive_title', 'archive_body', 'search_placeholder', 'all_label'],
            'conventions_network_index' => ['hero_eyebrow', 'hero_title', 'hero_body', 'access_title', 'access_body', 'catalog_title', 'catalog_body', 'contact_title', 'contact_body'],
            'news_index' => ['title' => 'News e aggiornamenti', 'slug' => 'news', 'canonical_url' => '/news', 'content' => ['breadcrumb_label' => 'News', 'eyebrow' => 'DAL MONDO REMEDIC', 'title' => 'News & aggiornamenti', 'subtitle' => 'Cosa succede in Remedic', 'body' => 'Novità dal centro, professionisti, servizi, tecnologie, collaborazioni e iniziative.', 'featured_label' => '', 'featured_cta_label' => 'Leggi la notizia', 'latest_title' => 'Ultime notizie', 'secondary_eyebrow' => 'DAL CENTRO', 'secondary_cta_label' => 'Leggi la notizia', 'archive_title' => 'Archivio News', 'archive_body' => 'Cerca tra tutte le notizie e gli aggiornamenti pubblicati da Remedic.', 'search_placeholder' => 'Cerca nelle news...', 'all_label' => 'Tutte'], 'configuration' => ['featured_post_id' => null, 'secondary_post_id' => null]],
            'health_pills_index' => ['title' => 'Pillole di salute', 'slug' => 'pillole-di-salute', 'canonical_url' => '/pillole-di-salute', 'content' => ['breadcrumb_label' => 'Pillole di salute', 'eyebrow' => 'PILLOLE DI SALUTE', 'title' => 'Capire meglio la propria salute', 'body' => 'Approfondimenti, prevenzione e consigli dei professionisti Remedic per orientarsi con maggiore consapevolezza.', 'featured_eyebrow' => 'IN PRIMO PIANO', 'featured_cta_label' => 'Leggi l’approfondimento', 'latest_title' => 'Ultimi approfondimenti', 'archive_title' => 'Archivio delle Pillole', 'archive_body' => 'Cerca per argomento o esplora tutti gli approfondimenti pubblicati da Remedic.', 'search_placeholder' => 'Cerca un argomento...', 'all_label' => 'Tutte'], 'configuration' => ['featured_post_id' => null]],
            'conventions_network_index' => ['title' => 'Convenzioni e network', 'slug' => 'convenzioni-e-network', 'canonical_url' => '/convenzioni-e-network', 'content' => ['hero_eyebrow' => 'CONVENZIONI', 'hero_title' => 'Convenzioni e network', 'hero_body' => '', 'access_title' => 'Più semplice accedere alle prestazioni', 'access_body' => '', 'catalog_title' => 'Tutte le convenzioni', 'catalog_body' => '', 'contact_title' => 'Non trovi la tua convenzione?', 'contact_body' => ''], 'configuration' => ['section_extras' => []]],
    ...
    public static function defaults(string $key): array
    {
        ...
        return match ($key) {
            'news_index' => ['title' => 'News e aggiornamenti', 'slug' => 'news', 'canonical_url' => '/news', 'content' => ['breadcrumb_label' => 'News', 'eyebrow' => 'DAL MONDO REMEDIC', 'title' => 'News & aggiornamenti', 'subtitle' => 'Cosa succede in Remedic', 'body' => 'Novità dal centro, professionisti, servizi, tecnologie, collaborazioni e iniziative.', 'featured_label' => '', 'featured_cta_label' => 'Leggi la notizia', 'latest_title' => 'Ultime notizie', 'secondary_eyebrow' => 'DAL CENTRO', 'secondary_cta_label' => 'Leggi la notizia', 'archive_title' => 'Archivio News', 'archive_body' => 'Cerca tra tutte le notizie e gli aggiornamenti pubblicati da Remedic.', 'search_placeholder' => 'Cerca nelle news...', 'all_label' => 'Tutte'], 'configuration' => ['featured_post_id' => null, 'secondary_post_id' => null]],
            'health_pills_index' => ['title' => 'Pillole di salute', 'slug' => 'pillole-di-salute', 'canonical_url' => '/pillole-di-salute', 'content' => ['breadcrumb_label' => 'Pillole di salute', 'eyebrow' => 'PILLOLE DI SALUTE', 'title' => 'Capire meglio la propria salute', 'body' => 'Approfondimenti, prevenzione e consigli dei professionisti Remedic per orientarsi con maggiore consapevolezza.', 'featured_eyebrow' => 'IN PRIMO PIANO', 'featured_cta_label' => 'Leggi l’approfondimento', 'latest_title' => 'Ultimi approfondimenti', 'archive_title' => 'Archivio delle Pillole', 'archive_body' => 'Cerca per argomento o esplora tutti gli approfondimenti pubblicati da Remedic.', 'search_placeholder' => 'Cerca un argomento...', 'all_label' => 'Tutte'], 'configuration' => ['featured_post_id' => null]],
            'medical_areas_index' => ['title' => 'Aree mediche', 'slug' => 'aree-mediche', 'canonical_url' => '/aree-mediche', 'content' => ['eyebrow' => 'AREE MEDICHE', 'title' => 'Specialità e aree mediche', 'body' => 'Esplora le specialità Remedic e trova l’area più adatta alla tua esigenza.']],
            ...
            'conventions_network_index' => [
                ...
                'slug' => 'convenzioni-e-network',
                'canonical_url' => '/convenzioni-e-network',
                'content' => [
                    'hero_eyebrow' => 'CONVENZIONI', 'hero_title' => 'Convenzioni e network', 'hero_body' => '',
                    'access_title' => 'Accesso alle prestazioni', 'access_body' => '',
                    'catalog_title' => 'Tutte le convenzioni', 'catalog_body' => '',
                    'contact_title' => 'Non trovi la tua convenzione?', 'contact_body' => '',
                ],
                'configuration' => ['section_extras' => []],
            ],
            default => throw new \InvalidArgumentException("Unknown site index key [{$key}]."),
        };
    }
