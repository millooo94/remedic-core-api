...
final class HomePageRegistry
{
    ...
    public static function defaults(string $key): array
    {
        return match ($key) {
            ...
            'conventions' => ['eyebrow' => 'CONVENZIONI E ASSICURAZIONI', 'title' => 'Ci prendiamo cura anche della parte burocratica', 'body' => 'Remedic collabora con i principali fondi sanitari, compagnie assicurative e circuiti convenzionati. Verifichiamo la tua copertura e gestiamo la pratica al posto tuo, così puoi concentrarti solo sulla tua salute.', 'cta_label' => 'Scopri tutte le convenzioni', 'items' => [['semantic_key' => 'direct_booking', 'title' => 'Prenotazione diretta', 'description' => 'Fissiamo la visita con gli enti convenzionati, senza passaggi inutili.'], ['semantic_key' => 'reimbursement_management', 'title' => 'Gestione dei rimborsi', 'description' => 'Ti assistiamo nella pratica e nella documentazione necessaria.'], ['semantic_key' => 'no_advance_payment', 'title' => 'Nessuna anticipazione', 'description' => 'Dove previsto dalla polizza, non anticipi nulla di tasca tua.']], 'selection_mode' => 'automatic', 'partner_ids' => [], 'footnote' => 'Non trovi il tuo fondo o la tua convenzione? Contattaci per verificarne le modalità.'],
            'faq' => ['eyebrow' => 'DOMANDE FREQUENTI', 'title' => 'Le risposte alle domande più comuni', 'body' => "Tutto quello che c'è da sapere prima della tua visita. Non trovi quello che cerchi?", 'support_title' => 'Il nostro team è a tua disposizione', 'support_body' => 'Scrivici o chiamaci: ti aiutiamo a trovare la risposta giusta.', 'cta_label' => 'Contatta il centro'],
            'contact' => ['eyebrow' => 'CONTATTI', 'title' => 'Un centro accogliente, facile da raggiungere', 'body' => 'Nel cuore della città, con orari ampi e spazi pensati per accoglierti. Trovi qui tutte le informazioni pratiche per la tua visita.'],
            'newsletter' => ['eyebrow' => 'NEWSLETTER', 'title' => 'Iscriviti e resta aggiornato sulla tua salute', 'benefits' => ['Una email al mese', 'Contenuti dei nostri medici', 'Niente spam'], 'email_placeholder' => 'nome@esempio.it', 'submit_label' => 'Iscriviti', 'privacy_text' => 'Iscrivendoti richiedi di ricevere la newsletter Remedic. Leggi la Privacy Policy.'],
            default => [],
        };
    }
