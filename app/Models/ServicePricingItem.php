...
class ServicePricingItem extends Model
{
    ...
    protected $fillable = ['service_pricing_profile_id', 'label', 'kind', 'price_amount', 'business_note', 'is_active', 'sort_order'];

    protected function casts(): array
    {
        return ['kind' => ServicePricingItemKind::class, 'price_amount' => 'decimal:2', 'is_active' => 'boolean', 'sort_order' => 'integer'];
    }
