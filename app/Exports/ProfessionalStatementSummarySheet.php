...
class ProfessionalStatementSummarySheet implements FromArray, ShouldAutoSize, WithEvents, WithTitle
{
    ...
    public function array(): array
    {
        return [
            ...
            ['Prestazioni da fatturare', $this->statement['totals']['performance_count']],
            ['Gia liquidate', $this->statement['totals']['already_liquidated_count']],
            ['Di cui gia liquidate', $this->statement['totals']['already_liquidated_amount']],
            ['Totale quote da fatturare', $this->statement['totals']['professional_amount']],
            [],
