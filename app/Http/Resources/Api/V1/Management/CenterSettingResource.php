    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'parking' => [
                ...
                'formatted_address' => $this->parking_address,
                'street_name' => $this->parking_street_name,
                'street_number' => $this->parking_street_number,
                'postal_code' => $this->parking_postal_code,
                'city' => $this->parking_city,
                'province' => $this->parking_province,
                'region' => $this->parking_region,
                'country' => $this->parking_country_name,
                'country_code' => $this->parking_country,
                'google_place_id' => $this->parking_google_place_id,
                'latitude' => $this->parking_latitude === null ? null : (float) $this->parking_latitude,
                'longitude' => $this->parking_longitude === null ? null : (float) $this->parking_longitude,
