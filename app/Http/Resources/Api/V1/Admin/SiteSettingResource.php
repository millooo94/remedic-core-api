...
class SiteSettingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'google_review_delay_days' => $this->google_review_delay_days,
            'google_review_delay_hours' => $this->google_review_delay_hours,
            'google_review_delay_minutes' => $this->google_review_delay_minutes,
            'google_review_delay_seconds' => $this->google_review_delay_seconds,
