...
class UpdateConsentPolicyVersionRequest extends FormRequest
{
    ...
    {
        $id = (int) $this->route('consent_policy_version')->id;

        return [
            'version' => ['required', 'string', 'max:255', Rule::unique('consent_policy_versions', 'version')->ignore($id)],
