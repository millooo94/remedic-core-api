...
return new class extends Migration
{
    ...
    {
        Schema::create('service_web_profiles', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('service_id')->unique();
            $table->foreign('service_id', 'service_web_profiles_service_fk')
    ...
    {
        Schema::dropIfExists('service_web_profiles');
    }
};
